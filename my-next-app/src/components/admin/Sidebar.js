...
import {
    ...
    FaHome, FaBell, FaCog, FaQuestionCircle, FaComments, FaEnvelope, FaHeadset, FaChartLine, FaFileAlt, FaExchangeAlt, FaUserFriends, FaBiking, FaUserShield, FaRss
} from "react-icons/fa";
        ...
        <>
            ...
            <aside className={`
                ...
                <nav className="p-2 space-y-1">
                    ...
                    {/* Subscribers (Single Link as per screenshot) */}
                    <Link
                        href="/admin/users/subscribers"
                        className={`flex items-center gap-3 px-4 py-2.5 rounded-md hover:bg-[#ffffff10] transition ${pathname === '/admin/users/subscribers' ? 'bg-amber-600 text-white' : ''}`}
                    >
                        <FaRss size={16} className="text-gray-400" />
